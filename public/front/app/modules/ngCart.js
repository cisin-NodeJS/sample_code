...
angular.module('ngCart', ['ngCart.directives'])
  ...
  .service('ngCart', ['$rootScope', 'ngCartItem', 'store', function ($rootScope, ngCartItem, store) {
    ...
    this.getShipping = function () {
      // console.log(this.getCart().items.length)
...
angular.module('ngCart.fulfilment', [])
  .service('fulfilmentProvider', ['$injector','$location', function ($injector,$location) {
  ...
  .service('ngCart.fulfilment.http', ['$http', '$location', 'ngCart', function ($http, $location, ngCart) {

    this.checkout = function (settings) {
        //get user details
      var __userData = localStorage.getItem("userData");
      var userId = '';
      if (__userData !== '' && __userData !== 'undefined' && __userData !== null) {
        var UD = JSON.parse(__userData);
        userId = UD.UserData._id;
      } else {
        var x;
        if (confirm("Do you want to continue without login") == true) {
          //guest user id
          userId = 2;
        } else {
          $location.path("/login");
        ...
        if (data.Error) {
          console.log(data);
            ...
            if (!data.Error) {
              ...
              alert('Error While order product , Please try again');
            }
        }
